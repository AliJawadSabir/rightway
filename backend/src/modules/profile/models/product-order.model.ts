...
export class ProductOrderModel extends BaseModel {
  public model;
  constructor() {
    super(ProductOrder);
  ...
  public create(item) {
    ...
    //   }else {
      ...
      // console.log('----------------------------------------');
      // console.log('result showing '+ item['products'][0]);
      // console.log('-------------------------------------------');
  ...
  public findByOrderId(orderId){
    return this.model.findAll(['id','orderId', 'productId', 'quantity'],
    {where:{orderId: orderId}}).then(res=>{
  ...
  public deleteByOrderId(orderId){
